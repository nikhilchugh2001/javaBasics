	 ...
	 public static void main(String[] args) throws Exception 
	    {
	        ...
	        Document doc = builder.parse(new FileInputStream(new File("C:\\Users\\Nikhil\\eclipse-workspace\\javaBasics\\shortjavaprograms\\src\\main\\java\\xmlUseCases\\sample.xml")));
